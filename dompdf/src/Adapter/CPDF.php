...
class CPDF implements Canvas
{
    ...
    static $PAPER_SIZES = [
        ...
        "patrimonio" => [0, 0, 212.5983, 141.7322],
        "etiqueta1" => [0, 0, 113.3858, 51.0236],
        "etiqueta2" => [0, 0, 141.7322, 209.7637],
        "etiqueta3" => [0, 0, 93.543252, 138.897556],
        "etiqueta4" => [0, 0, 90.543252, 130.897556],
    ];
