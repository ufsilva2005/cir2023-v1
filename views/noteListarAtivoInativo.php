									...
									{ ?>													
											<tr>
												...
												<td class='operations'>
                                                    ...
                                                    <div class="btn-group pull-left">
                                                    	<a href="./historicoComp.php?action=1&id=<?php echo $comp->idNotebook; ?>" class="btn btn-primary">H<i class="icon-remove"></i></a>
                                                    </div>
                                                    <div class="btn-group pull-left">
                                                    ...
                                                    <div class="btn-group pull-left">
														<?php                                    
                                                            if($statusComp != "ativo") 
                                                                {
                                                                    $html = "<a href='../controllers/ativarDesativarNot.php?action=5&id=$idNotebook' class='btn btn-small btn-success'>AT<i class='icon-remove'></i></a>";
                                                                    $inativo++;
																	echo $html;
                                                                }  
															else
                                                                {
                                                                    $html = "<a href='../controllers/ativarDesativarNot.php?action=6&id=$idNotebook' class='btn btn-small btn-danger'>DE<i class='icon-remove'></i></a>";
                                                                    $ativo++;
																	echo $html;
                                                                }                                    
                                                        ?>  
													...
													<div class="btn-group pull-left">
                                                        <a href="../gerarPdf/notebookImprimirDados.php?action=1&id=<?php echo $comp->idNotebook; ?>" class="btn btn-small btn-ufs">P<i class="icon-remove"></i></a>
                                                    </div>
                                                </td>			
											<tr>									
										<?php 
