        ...
        <nav class="navbar navbar-dark">
            <div class="line col-md-12 p-5 position-absolute start-5 top-0 bottom-50 end-250">
                ...
                <div class="panel-content">
                    <div class="col-md-12">
                        <form name="cadastro" id="cadastro" method="post" action="../controllers/notebooksCadastrar.php?action=1">
                            <fieldset>	
                                <div class="row">		
                                    <label>
                                ...
                                <div class="row">																						
                                    <div class="col px-md-1 col-md-2">
                                        ...
                                        <select class="form-control" name = "localNotebook[]" required>
                                            <option> </option>
                                            <option>CAE</option>
                                            <option>CIR</option>
                                            <option>DAA</option>
                                    ...
                                    <div class="col px-md-1 col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="localNotebook[]" pattern="[0-9]{4}+$" oninvalid="setCustomValidity('Somente Numeros!')" onchange="try{setCustomValidity('')}catch(e){}" placeholder="0000" maxlength="4">
                                    </div>
                                                                    
                                    <div class="col px-md-1 col-md-6">
                                        <label for="inputSuccess" class="control-label">Responsável pelo Setor:</label>
                                        <input type="text" class="form-control" name="localNotebook[]">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col px-md-1 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="localNotebook1" id="localNotebook1" required/>
                                    </div>
                                                
                                    <div class="col px-md-1 col-md-6">
                                        <label for="inputSuccess" class="control-label">Observação:</label>
                                        <input type="text" class="form-control" name="dadosNotebook[]">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col px-md-1 col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="dadosNotebook[]" pattern="[0-9]+$" oninvalid="setCustomValidity('Somente Numeros!')" onchange="try{setCustomValidity('')}catch(e){}" placeholder="0000000000" >
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col px-md-1 col-md-2">
                                        ...
                                        <select class="form-control"  name = "dadosNotebook[]" required>
                                            <option> </option>
                                ...
                                <div class="row">
                                    <div class="col px-md-1 col-md-2">
                                        ...
                                        <input type="text" class="form-control"  name="dadosNotebook[]" pattern="((^|\.)((25[0-5])|(2[0-4]\d)|(1\d\d)|([1-9]?\d))){4}$" placeholder="000.000.000.000" oninvalid="setCustomValidity('Endereco ip invalido!')" onchange="try{setCustomValidity('')}catch(e){}" >
                                    </div>
