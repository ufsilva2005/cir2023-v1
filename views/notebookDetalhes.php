        ...
        <nav class="navbar navbar-dark">
            <div class="line col-md-12 p-5 position-absolute start-5 top-0 bottom-50 end-250">
                ...
                <div class="panel-content">
                            ...
                            <fieldset>	
                                ...
                                <div class="row">
                                    ...
                                    <div class="col px-md-1 col-md-3">
                                        ...
                                        <input type="text" class="form-control" value="<?= $nomenotebook ?>" disabled>
                                    </div>												                                      
                                </div>		
                                ...
                                <div id="actions" class="row">
                                    <div class="col-md-12">
                                         <a href="../views/NotebookListar.php" ><button type="button" class="btn btn-outline-warning">Voltar</button></a>
                                    </div>				
                                </div>                                           
                            </fieldset>
                        <!--/form-->  
                    ...
                    <p></p>
                    <footer>
                        <p>&copy; <a href="">CADASTRO DE NOTEBOOKS</a></p>
                    </footer>
                </div>
            </div>
        </nav>
