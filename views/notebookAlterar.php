<?php
    ...
    require_once '../controllers/notebookBuscar.php';
...
?>
        ...
        <nav class="navbar navbar-dark">
            <div class="line col-md-12 p-5 position-absolute start-5 top-0 bottom-50 end-250">
                ...
                <h3 class="text-success">Cadastro do Notebook</h3>
                <div class="panel-content">
                    <div class="col-md-12">
                        <form name="cadastro" id="cadastro" method="post" action="../controllers/notebookAlterar.php">
                            <fieldset>	
                                <div class="row">		
                                    <label>
                                ...
                                <div class="row">																						
                                    <div class="col px-md-1 col-md-2">
                                        ...
                                        <select class="form-control"  name="localNotebook[]">
                                    ...
                                    <div class="col px-md-1 col-md-2">
                                        ...
                                        <input type="text" class="form-control"  name="localNotebook[]" value="<?= $ramal; $_SESSION['antRamal']=$ramal; ?> " >
                                    </div>
                                                                    
                                    <div class="col px-md-1 col-md-6">
                                        <label for="inputSuccess" class="control-label">Responsável pelo Setor:</label>
                                        <input type="text" class="form-control"  name="localNotebook[]" value="<?= $respSetor ; $_SESSION['antRespSetor']=$respSetor; ?>" >
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col px-md-1 col-md-6">
                                        ...
                                        <input type="text" class="form-control"  name="localNotebook1" id="localNotebook1" value="<?= $nomeLocal ; $_SESSION['antNomeLocal']=$nomeLocal; ?>" >
                                    </div>
                                                
                                    <div class="col px-md-1 col-md-6">
                                        <label for="inputSuccess" class="control-label">Observação:</label>
                                        <input type="text" class="form-control"  name="dadosNotebook[]" value="<?= $obs ; $_SESSION['antObs']=$obs; ?>" >
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col px-md-1 col-md-3">
                                        ...
                                        <input type="text" class="form-control"  name="dadosNotebook[]" pattern="[0-9]+$" oninvalid="setCustomValidity('Somente Numeros!')" 
                                    ...
                                    <div class="col px-md-1 col-md-3">
                                        ...
                                        <input type="text" class="form-control"  id = "nomeCir" name = "nomeCir" value="<?= $nomenotebook ; $_SESSION['antNomeNotebook']=$nomenotebook; ?>" >
                                    </div>												                                      
                                </div>		
                                ...
                                <div class="row">
                                    <div class="col px-md-1 col-md-2">
                                        ...
                                        <select class="form-control" name="dadosNotebook[]">
                                            <option><?= $sistemaOpera;
                                ...
                                <div class="row">
                                    <div class="col px-md-1 col-md-3">
                                        ...
                                        <input type="text" class="form-control"  name="dadosNotebook[]" pattern="((^|\.)((25[0-5])|(2[0-4]\d)|(1\d\d)|([1-9]?\d))){4}$"
                    ...
                    <p></p>
                    <footer>
                        <p>&copy; <a href="">CADASTRO NOTBOOKS</a></p>
                    </footer>
                </div>
            </div>
        </nav>        
