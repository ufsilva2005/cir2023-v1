<?php
    ...
    include_once "../controllers/notebookPesquisa.php";
...
?>
        ...
        <nav class="navbar navbar-dark">
            <div class="line col-md-12 p-5 position-absolute start-5 top-0 bottom-50 end-250">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; &emsp;&emsp;&emsp;
                                    ...
                                    <div class="btn-group pull-left">
                                        <a class='nav-link' href='./notebooksPesquisar.php'><button type='button' class='btn btn-outline-warning'>voltar</button> </a>
                                    </div>
                                </th>
                            </tr>
                        </thead>
                ...
                if ($tipoPesquisa != "divisao") {
                    include "../template/exibirPesqNote1.php";
                } else {
                    include "../template/exibirPesqNote2.php";
                }
                ?>
        ...
        <div class="fixed-bottom p-3 mb-2 bg-primary text-white">
            <div class="col px-md-1 col-md-2">
                <label for="inputSuccess" class="control-label">Total de notebookes:</label>
