            ...
            <div class="btn-group">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="../views/listarImpressoras.php">Listar Todas</a></li>
                        <li><a class="dropdown-item" href="../views/naoImplementada.php">pesquisar</a></li>
                        <li><a class="dropdown-item" href="../views/naoImplementada.php">Editar</a></li>
                        <li><a class="dropdown-item" href="../views/naoImplementada.php">Retificar</a></li>
                    </ul>
                </div>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="../views/naoImplementada.php">Data</a></li>
                        <li><a class="dropdown-item" href="../views/naoImplementada.php">2</a></li>
