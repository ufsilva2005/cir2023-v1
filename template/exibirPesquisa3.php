                                                            ...
                                                            <div class="btn-group pull-left">
                                                                <?php                                    
                                                                    if($statusImpressora != "ativo") 
                                                                        {
                                                                            $html = "<a href='../controllers/ativarDesativar.php?action=3&id=$idImpressora' class='btn btn-small btn-success'>AT<i class='icon-remove'></i></a>";
                                                                            $inativo++;
                                                                            echo $html;
                                                                        }  
                                                                    else
                                                                        {
                                                                            $html = "<a href='../controllers/ativarDesativar.php?action=4&id=$idImpressora' class='btn btn-small btn-danger'>DE<i class='icon-remove'></i></a>";
                                                                            $ativo++;
                                                                            echo $html;
                                                                        }                                    
                                                                ?>  
