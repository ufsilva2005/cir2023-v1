<?php	
    ...
    if($_SESSION['tipoPesquisa'] == "setor")
        {
            ...
            foreach($compAltDAO->  RelatNotSetor($_SESSION['valorPesquisa']) as $comp)                                             
                {  
    ...
    elseif($_SESSION['tipoPesquisa'] == "divisao")
        {
            $compAltDAO = new ControleCirDAO();
            foreach($compAltDAO->  RelatNotDivisao($_SESSION['valorPesquisa']) as $comp)                                             
                {  
				    $idNotebook = $comp->idNotebook;											
					$numCir[] = $comp->numCir;															
					$numPatrimonio[] = $comp->numPatrimonio; 
    ...
    elseif($_SESSION['tipoPesquisa'] == "andar")
        {
            $compAltDAO = new ControleCirDAO();
            foreach($compAltDAO->  RelatNotAndar($_SESSION['valorPesquisa']) as $comp)                                             
                {  
				    $idNotebook = $comp->idNotebook;											
					$numCir[] = $comp->numCir;															
					$numPatrimonio[] = $comp->numPatrimonio; 
    ...
    elseif($_SESSION['tipoPesquisa'] == "status")
        {
            $compAltDAO = new ControleCirDAO();
            foreach($compAltDAO->  RelatNotStatus($_SESSION['valorPesquisa']) as $comp)                                             
                {  
				    $idNotebook = $comp->idNotebook;											
					$numCir[] = $comp->numCir;															
					$numPatrimonio[] = $comp->numPatrimonio; 
    ...
    elseif($_SESSION['tipoPesquisa'] == "sistema")
        {
            $compAltDAO = new ControleCirDAO();
            foreach($compAltDAO->  RelatNotSistema($_SESSION['valorPesquisa']) as $comp)                                             
                {  
				    $idNotebook = $comp->idNotebook;											
					$numCir[] = $comp->numCir;															
					$numPatrimonio[] = $comp->numPatrimonio; 
    ...
    elseif($_SESSION['tipoPesquisa'] == "processador")
        {
            $compAltDAO = new ControleCirDAO();
            foreach($compAltDAO->  RelatNotProcessador($_SESSION['valorPesquisa']) as $comp)                                             
                {  
				    $idNotebook = $comp->idNotebook;											
					$numCir[] = $comp->numCir;															
					$numPatrimonio[] = $comp->numPatrimonio; 
     ...
     elseif($_SESSION['tipoPesquisa'] == "data")
        {
            $compAltDAO = new ControleCirDAO();
            foreach($compAltDAO->   RelatNotData($_SESSION['dataInComp'] , $_SESSION['dataOutComp'] ) as $comp)                                             
                {  
				    $idNotebook = $comp->idNotebook;											
					$numCir[] = $comp->numCir;															
					$numPatrimonio[] = $comp->numPatrimonio; 
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            <th>   
                                                <h5>
                                                    <h4 class="text-success"><strong> Relação dos   Notbooks ' .  $pesquisa . '</strong></h4>
                                                </h5> 
                                            </th>
                                        </tr>
                                    </thead>            
