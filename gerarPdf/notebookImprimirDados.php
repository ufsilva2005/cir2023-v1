                            ...
                            <div class="col-md-12 py-5 px-2">	  
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            <th>   
                                            <h5>
                                                    <h4 class="text-success"><strong> Dados do notebook </strong></h4>
                                                </h5> 
                                            </th>
                                        </tr>
                                    </thead>            
                                ...
                                <table class = "tableUfs">
                                    <thead>     
                                        <tr>
                                            <td style="width:50%">
                                                <h5><strong>Número do notebook: ' . $numCir . '</strong></h5>
                                            </td> 
                                            <td style="width:50%">
                                                <h5><strong>Nome: ' . $nomenotebook . '</strong></h5>
                                            </td>                                                              
                                        </tr>
                                        <tr>
                                            <td style="width:50%">
                                ...
                                <div class="row">
                                    <div class="col px-md-1 col-md-12">
                                        <table>                          
                                            ...
                                            <tr>    
                                                <td><h6>Status da notebook</h6></td>
