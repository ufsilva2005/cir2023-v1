...
--
-- Host: localhost
-- Tempo de geração: 04/09/2023 às 16:19
...
(35, 'PRNRESIDUOS', 'AK8B014256CO', '192.168.100.100', '00:25:36:91:06:7E', 'a:1:{i:0;s:2:\"30\";}', 'ativo', 'usb', 4, '2023-08-01', 'ULISSES FERREIRA DA SILVA', NULL, NULL, NULL, 4, 81);
...
--
ALTER TABLE `impressoras`
  MODIFY `idImpressora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
