...
--
-- Host: localhost:3306
-- Tempo de geração: 10/01/2024 às 17:08
...
(1, 1989, 34268, 123456, 'cir-ufs', '2023-09-13', 'ULISSES FERREIRA DA SILVA', '2023-11-06', 'ULISSES FERREIRA DA SILVA', 'LINUX', 'MSI', '16 Gb', '10.13.151.245', '4C:CC:6A:31:71:F6', 'a:1:{i:0;s:2:\"52\";}', 'ULISSES', 'ativo', 'CADASTRO TESTE', 4, 1, 651),
...
(11, '../historico/hist-Imp1D20230913h182342F2.txt', '2023-09-13', 'ULISSES FERREIRA DA SILVA', NULL, 1, 2),
(12, '../historico/hist-Comp1D20230929h104240F4.txt', '2023-09-29', 'ULISSES FERREIRA DA SILVA', 1, NULL, 4),
(13, '../historico/hist-Comp1D20230929h104258F4.txt', '2023-09-29', 'ULISSES FERREIRA DA SILVA', 1, NULL, 4),
(14, '../historico/hist-Imp1D20230929h141355F4.txt', '2023-09-29', 'ULISSES FERREIRA DA SILVA', NULL, 1, 4),
(15, '../historico/hist-Comp1D20231003h151152F2.txt', '2023-10-03', 'SUZANA COSTA VIRGINIO DE SOUZA', 1, NULL, 2),
(16, '../historico/hist-Comp1D20231003h151158F2.txt', '2023-10-03', 'SUZANA COSTA VIRGINIO DE SOUZA', 1, NULL, 2),
(17, '../historico/hist-Comp1D20231003h151221F2.txt', '2023-10-03', 'SUZANA COSTA VIRGINIO DE SOUZA', 1, NULL, 2),
(18, '../historico/hist-Comp1D20231106h143350F4.txt', '2023-11-06', 'ULISSES FERREIRA DA SILVA', 1, NULL, 4),
(19, '../historico/hist-Comp1D20231106h143959F4.txt', '2023-11-06', '4', NULL, NULL, 4),
(20, '../historico/hist-Comp1D20231106h144511F4.txt', '2023-11-06', '4', NULL, NULL, 4),
(21, '../historico/hist-Comp1D20231106h144814F4.txt', '2023-11-06', NULL, NULL, NULL, 4),
(22, '../historico/hist-Comp1D20231106h153030F4.txt', '2023-11-06', 'ULISSES FERREIRA DA SILVA', 1, NULL, 4),
(23, '../historico/hist-Comp1D20231108h114711F4.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', 1, NULL, 4),
(24, '../historico/hist-Comp1D20231108h114950F4.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', 1, NULL, 4),
(25, '../historico/hist-Comp1D20231108h114958F4.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', 1, NULL, 4),
(26, '../historico/hist-Comp1D20231108h115205F4.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', 1, NULL, 4),
(27, '../historico/hist-Comp1D20231108h115246F4.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', 1, NULL, 4),
(28, '../historico/hist-Comp1D20231108h152436F4.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', 1, NULL, 4),
(29, '../historico/hist-Imp1D20231108h160139F.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', NULL, 1, NULL),
(30, '../historico/hist-Imp1D20231108h160204F.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', NULL, 1, NULL),
(31, '../historico/hist-Comp4D20231128h155839F4.txt', '2023-11-28', 'ULISSES FERREIRA DA SILVA', 4, NULL, 4),
(32, '../historico/hist-Comp4D20231128h160657F4.txt', '2023-11-28', 'ULISSES FERREIRA DA SILVA', 4, NULL, 4),
(33, '../historico/hist-Comp1D20231128h160931F4.txt', '2023-11-28', 'ULISSES FERREIRA DA SILVA', 1, NULL, 4),
(34, '../historico/hist-Comp1D20231128h160934F4.txt', '2023-11-28', 'ULISSES FERREIRA DA SILVA', 1, NULL, 4),
(35, '../historico/hist-Comp4D20240110h163038F2.txt', '2024-01-10', 'SUZANA COSTA VIRGINIO DE SOUZA', 4, NULL, 2),
(36, '../historico/hist-Comp4D20240110h163055F2.txt', '2024-01-10', 'SUZANA COSTA VIRGINIO DE SOUZA', 4, NULL, 2);
...
--
ALTER TABLE `computador`
  MODIFY `idComputador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `historico`
  MODIFY `idHistorico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `setor`
  MODIFY `idSetor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
