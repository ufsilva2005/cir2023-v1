...
--
-- Host: localhost:3306
-- Tempo de geração: 08-Jul-2024 às 11:45
...
(191, 8, 'subsolo', '', '', 'MEDICINA NUCLEAR - LABORATÓRIO'),
...
(232, 8, '8° andar', '', '', 'SERVIÇO CARDIOLOGIA - PÓS'),
(233, 8, '8° andar', '', '', 'SERVIÇO CARDIOLOGIA'),
(234, 8, '8° andar', '', '', 'SERVIÇO CIRURGIA CARDIÁCA'),
...
(336, 10, '1° andar', '', '', 'DSC SAA NIR'),
(337, 10, '1° andar', '', '', 'DSC SAA'),
...
--
ALTER TABLE `setor`
  MODIFY `idSetor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=374;
