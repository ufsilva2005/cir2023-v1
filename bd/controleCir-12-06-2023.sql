...
--
-- Host: localhost
-- Tempo de geração: 12/06/2023 às 13:53
...
(1, 'prnmanut', 'R4P2X12492', '10.13.10.33', '', 28, 'ativo', 1, '2023-05-31', 'SUZANA COSTA VIRGINIO DE SOUZA', '0000-00-00', '', 'teste', 2, 1),
(2, '', 'R4P2X12499', '', '', 28, 'ativo', 1, '2023-05-31', 'SUZANA COSTA VIRGINIO DE SOUZA', '0000-00-00', '', '', 2, 49),
(3, '', 'R4P2X12489', '', '', 28, 'ativo', 1, '2023-05-31', 'SUZANA COSTA VIRGINIO DE SOUZA', '0000-00-00', '', '', 2, 50),
(4, '', 'R4P8917950', '', '', 28, 'ativo', 1, '2023-05-31', 'SUZANA COSTA VIRGINIO DE SOUZA', '0000-00-00', '', '', 2, 51),
(5, '', 'R4P2X12491', '', '', 28, 'ativo', 1, '2023-05-31', 'SUZANA COSTA VIRGINIO DE SOUZA', '0000-00-00', '', '', 2, 32),
(6, '', 'R4P2X12501', '', '', 28, 'ativo', 1, '2023-05-31', 'SUZANA COSTA VIRGINIO DE SOUZA', '0000-00-00', '', '', 2, 52),
(7, '', 'R4P9429137', '', '', 28, 'ativo', 1, '2023-05-31', 'SUZANA COSTA VIRGINIO DE SOUZA', '0000-00-00', '', '', 2, 53),
(8, '', 'X3BK007496', '', '', 29, 'ativo', 6, '2023-05-31', 'SUZANA COSTA VIRGINIO DE SOUZA', '0000-00-00', '', '', 2, 48),
...
(54, 5, '3° andar', '2895', 'EVANDRO VIEIRA', 'MANUTENÇÃO');
...
--
ALTER TABLE `setor`
  MODIFY `idSetor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
