...
--
-- Host: localhost
-- Tempo de geração: 28-Set-2023 às 17:58
...
(1, 3558, NULL, 2018009015, 'cir-suzana', '2023-09-13', 'SUZANA COSTA VIRGINIO DE SOUZA', '0000-00-00', '', 'WINDOWS 10', 'asus', '16 Gb', '10.13.151.244', '2C:FD:A1:C8:52:AB', 'SATA', NULL, 'ativo', 'TESTE SALVAR COMPUTADOR', 2, 1, 161),
(2, 1989, 34268, NULL, 'cir-ufs', '2023-09-13', 'ULISSES FERREIRA DA SILVA', '0000-00-00', '', 'LINUX', 'msi', '16 Gb', '10.13.151.245', '4C:CC:6A:31:71:F6', 'SATA', NULL, 'ativo', 'CADASTRO TESTE', 4, 1, 640),
(3, 4471, 0, 0, 'hu4471', '2023-09-20', 'ULISSES FERREIRA DA SILVA', '0000-00-00', '', 'WINDOWS 10', 'asus top aming', '16 Gb', '10.13.151.4', '50:EB:F6:37:AE:49', 'SSD', NULL, 'ativo', 'SUBSTITUI A MAQUINA CIR-UFSWIN', 4, 1, 727);
...
--
ALTER TABLE `computador`
  MODIFY `idComputador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `modeloImpressora`
  MODIFY `idModelo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `setor`
  MODIFY `idSetor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
ALTER TABLE `tipoProcessadores`
  MODIFY `idTipoProcessador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=728;
