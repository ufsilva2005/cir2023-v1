...
--
-- Host: localhost:3306
-- Tempo de geração: 11-Abr-2024 às 11:52
...
(1, 1989, 34268, 123456, 'cir-ufs', '2023-09-13', 'ULISSES FERREIRA DA SILVA', '2023-11-06', 'ULISSES FERREIRA DA SILVA', 'LINUX', 'MSI', '16 Gb', '10.13.151.245', '4C:CC:6A:31:71:F6', 'a:1:{i:0;s:2:\"52\";}', 'ULISSES', 'inativo', 'CADASTRO TESTE', 4, 1, 651),
(2, 4471, NULL, NULL, 'hu4471', '2023-09-27', 'ULISSES FERREIRA DA SILVA', '0000-00-00', '', 'WINDOWS 10', 'ASUS TOP GAMING', '16 Gb', '10.13.151.4', '00:25:36:91:06:7E', 'a:1:{i:0;s:1:\"5\";}', 'ULISSES', 'ativo', 'CADASTRO TESTE', 4, 5, 727),
(3, 4466, NULL, NULL, 'hu4466', '2023-10-03', 'ULISSES FERREIRA DA SILVA', '0000-00-00', '', 'WINDOWS 10', 'GIGABYTE H510', '16 Gb', '10.13.151.4', '74:56:3C:01:87:82', 'a:2:{i:0;s:1:\"3\";i:1;s:2:\"13\";}', 'PAULO', 'ativo', '', 4, 1, 653),
(4, 3304, NULL, NULL, 'hu3304', '2023-10-03', 'ULISSES FERREIRA DA SILVA', '2023-11-28', 'ULISSES FERREIRA DA SILVA', 'WINDOWS 10', '', '8 Gb', '10.201.1.89', 'D8:5E:D3:77:9A:CA', 'a:2:{i:0;s:2:\"17\";i:1;s:1:\"9\";}', 'ULISSES', 'ativo', '', 4, 76, 728),
(5, 1, NULL, NULL, NULL, '2024-03-25', 'ULISSES FERREIRA DA SILVA', '0000-00-00', '', 'WINDOWS VISTA', '', '4 Gb', '', '2C:FD:A1:C8:52:AA', 'a:1:{i:0;s:1:\"6\";}', '', 'ativo', '', 4, 77, 652);
...
--
-- Estrutura da tabela `empresaMaterial`
--
...
CREATE TABLE `empresaMaterial` (
  ...
  `numNota` varchar(50) DEFAULT NULL,
...
--
-- Extraindo dados da tabela `empresaMaterial`
--

INSERT INTO `empresaMaterial` (`idEmpresa`, `nomeEmpresa`, `cnpj`, `numNota`, `numProcesso`, `numEmpenho`, `obs`, `idEntMat`) VALUES
(1, 'teste', '33.663.683/0053-47', '1235', '15854', '14965', 'teste5', 1),
(2, 'informatica pinto', '33.663.683/0053-47', '001.002.321', '', '', 'fujb teste', 2);
...
(5, 'SALOMÃO HENRIQUE MARQUES', 'inativo', 'salomaohenrique', '$2y$12$ta2oFIo/GUkqh6YrXcJw5ObdKJDvzXs1BwUlbaGdMR/84zgkZW9B.', '2023-06-14', '0000-00-00', 2, 4),
(6, 'EVANDRO VIEIRA', 'ativo', 'evandro', '$2y$12$6LYkioZVGg1Zmb6z4QF.2e2xEy21LGSsk1rB/vH2RMLrbha9Avkpi', '2024-01-10', '0000-00-00', 6, 6);
...
(1, '../historico/hist-Imp1D20230614h205703F2.txt', '2023-06-14', 'ULISSES FERREIRA DA SILVA', NULL, NULL, 1, 2),
(2, '../historico/hist-Imp14D20230720h141350F2.txt', '2023-07-20', 'SUZANA COSTA VIRGINIO DE SOUZA', NULL, NULL, 14, 2),
(3, '../historico/hist-Imp1D20230728h175712F2.txt', '2023-07-28', 'SUZANA COSTA VIRGINIO DE SOUZA', NULL, NULL, 1, 2),
(4, '../historico/hist-Imp1D20230728h175744F2.txt', '2023-07-28', 'SUZANA COSTA VIRGINIO DE SOUZA', NULL, NULL, 1, 2),
(5, '../historico/hist-Imp15D20230731h134727F2.txt', '2023-07-31', 'SUZANA COSTA VIRGINIO DE SOUZA', NULL, NULL, 15, 2),
(6, '../historico/hist-Imp27D20230801h183204F2.txt', '2023-08-01', 'SUZANA COSTA VIRGINIO DE SOUZA', NULL, NULL, 27, 2),
(7, '../historico/hist-Imp28D20230801h183310F2.txt', '2023-08-01', 'SUZANA COSTA VIRGINIO DE SOUZA', NULL, NULL, 28, 2),
(8, '../historico/hist-Imp28D20230803h173550F2.txt', '2023-08-03', 'SUZANA COSTA VIRGINIO DE SOUZA', NULL, NULL, 28, 2),
(9, '../historico/hist-Imp28D20230803h173609F2.txt', '2023-08-03', 'SUZANA COSTA VIRGINIO DE SOUZA', NULL, NULL, 28, 2),
(10, '../historico/hist-Imp23D20230811h165031F2.txt', '2023-08-11', 'SUZANA COSTA VIRGINIO DE SOUZA', NULL, NULL, 23, 2),
(11, '../historico/hist-Imp1D20230913h182342F2.txt', '2023-09-13', 'ULISSES FERREIRA DA SILVA', NULL, NULL, 1, 2),
(12, '../historico/hist-Comp1D20230929h104240F4.txt', '2023-09-29', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(13, '../historico/hist-Comp1D20230929h104258F4.txt', '2023-09-29', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(14, '../historico/hist-Imp1D20230929h141355F4.txt', '2023-09-29', 'ULISSES FERREIRA DA SILVA', NULL, NULL, 1, 4),
(15, '../historico/hist-Comp1D20231003h151152F2.txt', '2023-10-03', 'SUZANA COSTA VIRGINIO DE SOUZA', 1, NULL, NULL, 2),
(16, '../historico/hist-Comp1D20231003h151158F2.txt', '2023-10-03', 'SUZANA COSTA VIRGINIO DE SOUZA', 1, NULL, NULL, 2),
(17, '../historico/hist-Comp1D20231003h151221F2.txt', '2023-10-03', 'SUZANA COSTA VIRGINIO DE SOUZA', 1, NULL, NULL, 2),
(18, '../historico/hist-Comp1D20231106h143350F4.txt', '2023-11-06', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(19, '../historico/hist-Comp1D20231106h143959F4.txt', '2023-11-06', '4', NULL, NULL, NULL, 4),
(20, '../historico/hist-Comp1D20231106h144511F4.txt', '2023-11-06', '4', NULL, NULL, NULL, 4),
(21, '../historico/hist-Comp1D20231106h144814F4.txt', '2023-11-06', NULL, NULL, NULL, NULL, 4),
(22, '../historico/hist-Comp1D20231106h153030F4.txt', '2023-11-06', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(23, '../historico/hist-Comp1D20231108h114711F4.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(24, '../historico/hist-Comp1D20231108h114950F4.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(25, '../historico/hist-Comp1D20231108h114958F4.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(26, '../historico/hist-Comp1D20231108h115205F4.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(27, '../historico/hist-Comp1D20231108h115246F4.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(28, '../historico/hist-Comp1D20231108h152436F4.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(29, '../historico/hist-Imp1D20231108h160139F.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', NULL, NULL, 1, NULL),
(30, '../historico/hist-Imp1D20231108h160204F.txt', '2023-11-08', 'ULISSES FERREIRA DA SILVA', NULL, NULL, 1, NULL),
(31, '../historico/hist-Comp4D20231128h155839F4.txt', '2023-11-28', 'ULISSES FERREIRA DA SILVA', 4, NULL, NULL, 4),
(32, '../historico/hist-Comp4D20231128h160657F4.txt', '2023-11-28', 'ULISSES FERREIRA DA SILVA', 4, NULL, NULL, 4),
(33, '../historico/hist-Comp1D20231128h160931F4.txt', '2023-11-28', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(34, '../historico/hist-Comp1D20231128h160934F4.txt', '2023-11-28', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(35, '../historico/hist-Comp4D20240110h163038F2.txt', '2024-01-10', 'SUZANA COSTA VIRGINIO DE SOUZA', 4, NULL, NULL, 2),
(36, '../historico/hist-Comp4D20240110h163055F2.txt', '2024-01-10', 'SUZANA COSTA VIRGINIO DE SOUZA', 4, NULL, NULL, 2),
(37, '../historico/hist-Comp1D20240328h143052F4.txt', '2024-03-28', 'ULISSES FERREIRA DA SILVA', NULL, NULL, 1, NULL),
(38, '../historico/hist-Comp1D20240328h143138F4.txt', '2024-03-28', 'ULISSES FERREIRA DA SILVA', NULL, NULL, 1, NULL),
(39, '../historico/hist-Comp1D20240328h143140F4.txt', '2024-03-28', 'ULISSES FERREIRA DA SILVA', NULL, NULL, 1, NULL),
(40, '../historico/hist-Comp1D20240328h143141F4.txt', '2024-03-28', 'ULISSES FERREIRA DA SILVA', NULL, NULL, 1, NULL),
(41, '../historico/hist-Note1D20240404h113640F4.txt', '2024-04-04', 'ULISSES FERREIRA DA SILVA', NULL, 1, NULL, 4),
(42, '../historico/hist-Note1D20240404h165743F4.txt', '2024-04-04', 'ULISSES FERREIRA DA SILVA', NULL, 1, NULL, 4),
(43, '../historico/hist-Note1D20240404h165857F4.txt', '2024-04-04', 'ULISSES FERREIRA DA SILVA', NULL, 1, NULL, 4),
(44, '../historico/hist-Comp1D20240404h165927F4.txt', '2024-04-04', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(45, '../historico/hist-Comp1D20240404h170023F4.txt', '2024-04-04', 'ULISSES FERREIRA DA SILVA', 1, NULL, NULL, 4),
(46, '../historico/hist-Note1D20240404h170157F4.txt', '2024-04-04', 'ULISSES FERREIRA DA SILVA', NULL, 1, NULL, 4),
(47, '../historico/hist-Note1D20240404h170202F4.txt', '2024-04-04', 'ULISSES FERREIRA DA SILVA', NULL, 1, NULL, 4),
(48, '../historico/hist-Imp1D20240408h141720F4.txt', '2024-04-08', 'ULISSES FERREIRA DA SILVA', NULL, NULL, 1, 4);
...
(3, 'C004723', 'TONNER 12A', '0', '0', 173, 'inativo'),
...
(12, 'C013713', 'MOUSE ÓPTICO USB', '0', '0', 100, 'ativo'),
...
(28, 'CIR-001', 'TONNER TK3182', '0', 'UN', 10, 'ativo'),
(29, 'CIR-002', 'TONNER - BOLSA DE TINTA', '0', 'UN', 5, 'ativo'),
...
(39, 'CIR-012', 'CARTUCHO DE TINTA R04L - AMARELO', '0', '0', 2, 'ativo'),
...
(44, 'CIR-017', 'TRANSRECIVER', '0', 'UN', 14, 'ativo'),
(45, 'CIR-018', 'PULSEIRA', '0', 'UN', 0, 'ativo');
...
(15, 'ativo', 'EPSON WF - C5890'),
(16, 'ativo', 'EPSON WF - C5790');
...
INSERT INTO `notebook` (`idNotebook`, `numCir`, `numPatrimonio`, `numPatReitoria`, `nomenotebook`, `dataCadastro`, `respCadastro`, `dataAltCadastro`, `respAltCadastro`, `sistemaOpera`, `modelMaquina`, `memoria`, `numIp`, `numMac`, `tipoHD`, `nomeUsuario`, `statusComp`, `obs`, `idFuncionario`, `idSetor`, `idTipoProcessador`) VALUES
(1, 1, 3, 2, 'laptop-001', '2024-03-28', 'ULISSES FERREIRA DA SILVA', '0000-00-00', '', 'WINDOWS 10', 'DELL', '8 Gb', '10.10.10.10', '2C:FD:A1:C8:52:AB', 'a:1:{i:0;s:1:\"8\";}', 'PAULO', 'ativo', 'TESTE', 4, 2, 652);
...
(76, 1, '1° andar', '2292', '', 'REDE'),
(77, 1, '1° andar', '2292', 'CARLOS VELASCO', 'SALA DA REDE'),
(78, 2, '1° andar', '2352', '', 'SDM - ABERTURA DE PRONTUÁRIO'),
(79, 2, '1° andar', '2230', '', 'SDM - SECRETARIA'),
(80, 2, '1° andar', '2256', '', 'SDM - SAM'),
(81, 2, '1° andar', '2250', '', 'SAA - CHEFIA'),
(82, 10, '1° andar', '2241', '', 'SAA'),
(83, 3, '1° andar', '2796', '', 'GABINETE'),
(84, 2, '1° andar', '2250', '', 'RECEPÇÃO');
...
(730, ' INTEL CORE I9 - 13900KS - 6.00 GHZ', 'ativo');
...
--
-- Índices para tabela `empresaMaterial`
--
...
--
ALTER TABLE `computador`
  MODIFY `idComputador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `entraMaterial`
  MODIFY `idEntMat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `material`
  MODIFY `idMaterial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT de tabela `modeloImpressora`
--
ALTER TABLE `modeloImpressora`
  MODIFY `idModelo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `notebook`
  MODIFY `idNotebook` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `setor`
  MODIFY `idSetor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
...
--
-- Limitadores para a tabela `empresaMaterial`
--
ALTER TABLE `empresaMaterial`
