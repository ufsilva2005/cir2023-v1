	...
	class Notebook
		{
			...
			// Recebe  parametros 
			public function __construct ($idNotebook = "", $numCir = null, $numPatrimonio = null, $numPatReitoria = null, 
			$nomeNotebook = null, $dataCadastro = null, $respCadastro = null, $dataAltCadastro= null, $respAltCadastro = null, 
			...
			$nomeUsuario = null, $statusComp = null, $obs = null, $idFuncionario = null, $idSetor = null,$idTipoProcessador = null) 
			
				{
					...
					$this->nomeNotebook	= $nomeNotebook;
			...
			//NOME DO Notebook
			public function getNomeNotebook() 
				{     
					return $this->nomeNotebook;
				}
			public function setNomeNotebook($nomeNotebook) 
				{     
					$this->nomeNotebook = $nomeNotebook;
				}
